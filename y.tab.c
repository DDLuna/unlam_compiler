...
{
       0,   127,   127,   130,   131,   132,   135,   138,   139,   142,
     143,   144,   145,   149,   150,   151,   155,   156,   159,   160,
     163,   168,   175,   182,   191,   197,   201,   206,   213,   216,
     219,   220,   223,   226,   227,   228,   229,   232,   235,   236,
...
#line 127 "Sintactico.y"
    {escribir_tabla_de_simbolos(); printf("Compilación exitosa\n"); (yyval.ast) = (yyvsp[(1) - (1)].ast); a=(yyval.ast);}
    break;
...
#line 145 "Sintactico.y"
    {
		...
		crear_nodo("PRINT",NULL,NULL,crear_hoja((yyvsp[(2) - (2)].string),NULL));
		}
    break;
...
#line 149 "Sintactico.y"
    {(yyval.ast) = crear_nodo("PRINT",NULL,NULL,crear_hoja((yyvsp[(2) - (2)].id),NULL));}
    break;
...
#line 150 "Sintactico.y"
    {(yyval.ast) = crear_nodo("READ",NULL,NULL,crear_hoja((yyvsp[(2) - (2)].id),NULL));}
    break;
...
#line 191 "Sintactico.y"
    {
		(yyval.ast) = crear_nodo("=", NULL, crear_hoja((yyvsp[(2) - (4)].id), NULL), (yyvsp[(4) - (4)].ast));  	
		guardar_cte_tabla_de_simbolos((yyvsp[(2) - (4)].id),tipo_dato);
		}
    break;
...
#line 197 "Sintactico.y"
    {
		tipo_dato = "constString"; strcpy(valor_const, (yyvsp[(1) - (1)].string));  
...
#line 201 "Sintactico.y"
    {
		tipo_dato = "constInt"; 
		itoa((int)(yyvsp[(1) - (1)].num), valor_const, 10);  
...
#line 206 "Sintactico.y"
    {
		...
		sprintf(valor_const,"%d",(yyvsp[(1) - (1)].real));  ////antes aca estaba ftoa($1, valor_const, 10); pero al compi no le gustaba
...
#line 213 "Sintactico.y"
    {verificar_existencia((yyvsp[(1) - (3)].id)); (yyval.ast) = crear_nodo("=", NULL, crear_hoja((yyvsp[(1) - (3)].id), NULL), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 232 "Sintactico.y"
    {(yyval.ast) = crear_nodo((yyvsp[(2) - (3)].op_log), NULL, (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 243 "Sintactico.y"
    {(yyval.ast) = crear_nodo("+", NULL, (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 250 "Sintactico.y"
    {(yyval.ast) = crear_nodo("DIV", NULL, (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 251 "Sintactico.y"
    {(yyval.ast) = crear_nodo("MOD", NULL, (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 256 "Sintactico.y"
    {(yyval.ast) = crear_hoja((yyvsp[(1) - (1)].id), NULL);}
    break;
...
#line 258 "Sintactico.y"
    {guardar_tabla_de_simbolos((yyvsp[(1) - (1)].real),"float", !ES_ID); (yyval.ast) = crear_hoja((yyvsp[(1) - (1)].real), "real");}
    break;
