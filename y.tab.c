...
{
       0,   140,   140,   143,   144,   145,   148,   151,   152,   155,
     156,   157,   158,   162,   163,   164,   168,   169,   172,   173,
     176,   181,   188,   195,   204,   210,   215,   220,   227,   232,
     235,   236,   239,   242,   243,   244,   245,   248,   251,   252,
...
#line 210 "Sintactico.y"
    {
		...
		strcpy(valor_const, (yyvsp[(1) - (1)].string));  
...
#line 215 "Sintactico.y"
    {
		...
		strcpy(valor_const, (yyvsp[(1) - (1)].num));  
...
#line 220 "Sintactico.y"
    {
		...
		strcpy(valor_const, (yyvsp[(1) - (1)].real)); 
...
#line 248 "Sintactico.y"
    {(yyval.ast) = crear_nodo((yyvsp[(2) - (3)].op_log), calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 259 "Sintactico.y"
    {(yyval.ast) = crear_nodo("+", calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 266 "Sintactico.y"
    {(yyval.ast) = crear_nodo("DIV", calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast));}
    break;
...
#line 267 "Sintactico.y"
    {(yyval.ast) = crear_nodo("-", calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(1) - (3)].ast), crear_nodo("*", calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(3) - (3)].ast), crear_nodo("/", calcular_resultante(obtener_tipo_arbol((yyvsp[(1) - (3)].ast)), obtener_tipo_arbol((yyvsp[(3) - (3)].ast))), (yyvsp[(1) - (3)].ast), (yyvsp[(3) - (3)].ast))));}
    break;
